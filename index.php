    ...
    $array_q =[
        [
            [
                    ...
                    <a href="https://support.google.com/legal/contact/lr_eudpa?product=websearch&amp;hl=it">modulo web</a>.
            ...
            [
                    ...
                    <ol type="a">
                    <li class="smANld">Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.
                    </li>
                    <li class="smANld">
                    ...
                    <a href="country-association-form">
                    Contattaci
                    </a>
            ...
            [
                    ...
                    del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. Inoltre, se, ai sensi delle leggi europee per la protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, 
                    <a href="https://support.google.com/legal/contact/lr_eudpa?product=websearch&amp;hl=it">
                    fai clic qui
                    </a>. 
                    Una volta che i contenuti saranno stati rimossi e che Google avrà rilevato l aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. In caso di una richiesta di rimozione urgente, è inoltre possibile 
                    <a href="https://support.google.com/websearch/troubleshooter/3111061?hl=it">
            ...
            [
                    ...
                    'risposta' =>'
                    <p>
                    In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina web di destinazione anche l indirizzo Internet, o URL, della pagina dei risultati di ricerca sotto forma di 
                    <a href="privacy/key-terms#toc-terms-referrer-url">
                    URL referrer
                    </a>.
                    Talvolta, l URL della pagina dei risultati di ricerca potrebbe contenere la query di ricerca che hai inserito. Se utilizzi la ricerca SSL (la funzione di ricerca criptata di Google), nella maggior parte dei casi i termini di ricerca non vengono inviati come parte dell URL negli URL referrer. Questo comportamento può fare eccezione, ad esempio se utilizzi alcuni browser meno diffusi. Ulteriori informazioni sulla ricerca SSL sono disponibili 
                    <a href="https://support.google.com/websearch/answer/173733">
                    qui
                    </a>.
